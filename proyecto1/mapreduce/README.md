# Universidad EAFIT
# Curso ST0263 Tópicos Especiales en Telemática, 2025-2
...
* correr la versión serial / secuencial asumimiendo todos los datos locales:
    ...
    $ cd mapreduce
    $ python wordcount-local.py ./gutenberg-small/*.txt > salida-serial.txt
...
>		user@master$ cd mapreduce
>		user@master$ python wordcount-mr.py ./gutenberg-small/*.txt
